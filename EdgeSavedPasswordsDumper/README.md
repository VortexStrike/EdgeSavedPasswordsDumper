...
## Requirements
- Presumably any Edge versions on Windows/Linux that's Chromium based (from version from 79 until 148). Microsoft has backpedaled and fixed this feature in version 148.0.3967.83.
