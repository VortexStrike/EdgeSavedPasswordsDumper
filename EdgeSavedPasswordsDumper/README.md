...
## Requirements
- Any Edge versions on Windows that's Chromium based (from version 79 and newer, including 147.0.3912.98 and any **future** version, as Microsoft won't change this feature).
